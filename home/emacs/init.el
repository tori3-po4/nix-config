...
;; Keep generated state below the active XDG/legacy Emacs directory.  ELPA
;; byte-code and quickstart files are not guaranteed to be backward-compatible,
;; so Emacs 31 never reads artifacts previously generated by Emacs 32.
